...
struct mapping
{
    uint32_t _map_ip_address;
    EthernetAddress _map_ethernet_address;
    size_t _map_left_time;
};
...
class NetworkInterface {
  private:
    ...
    std::deque<mapping> _map_cache{};
    std::map<Address, InternetDatagram> _ip_queue{};
    std::map<Address, size_t> _ip_life{};
